                ...
                <div class="col-md-9">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <form class ="form" action="{{ route('admin.socialmedia.update',$socials->id) }}" method="POST" >
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control" value="{{$socials->name}}">
                                            @error('name')
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="link" name="link" class="form-control" value="{{$socials->link}}">
                                            @error('link')
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="icon" name="icon" class="form-control" value="{{$socials->icon}}">
                                            @error('icon')
